    ...
    <div className="mt-5 md:mx-5 md:my-15 lg:mx-10 lg:my-18 flex justify-between">
      <div className="space-y-5 lg:space-y-10 ">
        ...
        <div className="space-y-3">
          ...
          <p className="font-semibold whitespace-nowrap text-dark-200 md:text-xl lg:text-2xl  flex items-center">
      ...
      <div className="flex flex-col items-center mr-2 md:m-0">
