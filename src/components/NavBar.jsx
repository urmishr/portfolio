...
export default function NavBar() {
  ...
  return (
    <nav className="mx-4 my-5 md:m-5 px-3 py-5 backdrop-blur-md dark:bg-dark-500/50 bg-light-100/40 shadow-light rounded-lg border border-dark-400/20 dark:border dark:border-dark-200/20 sticky top-5">
